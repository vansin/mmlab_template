export DNAME=10185
export algorthm_path=yolox/yolox_s_8x8_300e_coco.py
...
python /project/mmlab_template/tools/train_new.py /project/mmlab_template/configs/${DNAME}/${algorthm_path} --work-dir /project/train/models --auto-resume
