...
/project/mmlab_template/work_dirs/tablebank_cvpr2020_both/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/epoch_12.pth \
/project/mmlab_template/data/table/images/zalacznik_2_2.jpg \
--work-dir /project/mmlab_template/work_dirs/tablebank_cvpr2020_both/faster_rcnn/faster_rcnn_r50_fpn_1x_coco \
--device cuda \
--dump-info
