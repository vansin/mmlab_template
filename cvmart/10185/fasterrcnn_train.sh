...
python /project/mmlab_template/tools/train.py /project/mmlab_template/configs/${DNAME}/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py --work-dir /project/train/models/${DNAME} --auto-resume