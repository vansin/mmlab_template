...
from mmdet_custom.datasets import D10185Dataset

def fire_classes():
    return D10185Dataset.CLASSES
...
def cvt_annotations(xml_dirs, out_ann_file, out_valid_img_dir):
...
def main():
    ...
    xml_path = ['/home/data/918']
    json_out_path = '/tmp/10185.json'
    cvt_annotations(
        xml_path,
        json_out_path,
