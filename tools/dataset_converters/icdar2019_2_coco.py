...
from mmdet_custom.datasets.tabnet import TableDataset

label_ids = {name: i for i, name in enumerate(TableDataset.CLASSES)}
...
def parse_xml(xml_path):
    ...
    img_path = img_path.replace('_xml', '_img')
...
def cvt_annotations(xml_dir, out_ann_file):
...
def main():
    ...
    prefix = '/project/icdar_tracka_modern'
    xml_path = prefix + '/train_xml'
